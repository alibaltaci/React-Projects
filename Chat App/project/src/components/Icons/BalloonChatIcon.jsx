...
export default function BalloonChatIcon() {

    const svgContent = `
    <svg width="4rem" height="4rem" viewBox="-6.4 -6.4 76.80 76.80" xmlns="http://www.w3.org/2000/svg" fill="#000000">
